  ...
  return (
    hidden || (
      <motion.div
        ...
        onHoverEnd={() =>
          currentVariant === "floatingExpanded" && setCurrentVariant("floating")
        }
        onClick={handleNavbarClick}
      >
        <div className="flex flex-row gap-1 justify-between items-center">
          <div>          {currentVariant != "floatingExpanded" ? (
            <svg
          ...
          <div className="hover:bg-gray-800 p-1 cursor-pointer duration-500 rounded-md ">
        ...
        <div className="p-1 h-full flex flex-col"></div>
      </motion.div>
    )
  );
}
