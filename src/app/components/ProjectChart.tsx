...
export default function ProjectChart(props: ProjectChartProps) {
  return (
    <div className="flex flex-col gap-2 p-4 dark:bg-gray-950 dark:text-slate-200 rounded-xl max-w-full bg-slate-200">
        <div className="text-slate-600 dark:text-gray-300 flex flex-row justify-between"><h1>{props.title}</h1> <a target="_black" href={props.link} className=" underline px-3 py-1 rounded-xl bg-blue-800 text-xs text-center text-white hover:bg-blue-400 duration-500">link</a></div>
